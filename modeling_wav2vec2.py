...
class Wav2Vec2GumbelVectorQuantizer(nn.Module):
    ...
    def forward(self, hidden_states, mask_time_indices=None):
        ...
        return codevectors, perplexity,codevector_probs,self.codevectors
...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        quantized_features, codevector_perplexity,codevector_probs,codevectors = self.quantizer(
        ...
        return codevector_probs,codevectors
